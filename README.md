...
git clone https://github.com/alobaidy98/ahmed.B.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf ahmed.B && rm -rf .telegram-cli && git clone https://github.com/alobaidy98/ahmed.B.git && cd ahmed.B && ./launch.sh install && ./launch.sh
~~~~~
